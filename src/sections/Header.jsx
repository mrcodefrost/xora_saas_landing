...
const Header = () => {
    ...
    useEffect(() => {
        ...
        // for the browser to track this event
    ...
    return (
        <header className={clsx("fixed top-0 left-0 z-50 w-full py-10 transition-all duration-500 max-lg:py-4", hasScrolled && "py-2 bg-black-100 backdrop-blur-[8px]")}>
            <div className="container flex h-14 items-center max-lg:px-5">
                ...
                <div className={clsx("w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:bg-s2 max-lg:opacity-0",
                ...
                max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
                    <nav className="max-lg:relative max-lg:z-2 max-lg:my-auto">
                        <ul className="flex max-lg:block max-lg:px-12">
                            ...
                            <li className="nav-logo">
                                <LinkScroll to="hero" offset={-250} spy smooth className={clsx(
                    ...
                    <div className="lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[-290px] -translate-y-1/2 rotate-90">
                        ...
                        />
                        <img src="/images/bg-outlines-fill.svg" alt="outline"
                        width={960}
                        height={380}
